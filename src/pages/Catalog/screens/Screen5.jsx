    ...
    <Wrapper>
      ...
      <Content>
        ...
        <div className='col-span-2 indent-6'>
          <Text>
            Шкафы-купе в современных интерьерах смотрятся стильно и оригинально, однако шкафы с классическими распашными
            дверями не перестают быть популярными среди покупателей.
          </Text>
          <Text>
            Современный шкаф с распашными дверями гармонично впишется в любой дизайн комнаты благодаря большому
            разнообразию моделей. Распашные шкафы имеют презентабельный вид, при этом являются удобными и
            вместительными.
          </Text>
        </div>
        ...
        <div className='col-span-2 indent-6'>
          <Text>
            В MEBEL-178 Вы можете заказать распашной шкаф в спальню, гостиную, детскую или прихожую по индивидуальному
            проекту. Наши опытные дизайнеры помогут Вам на любом этапе от выбора материала и цвета изделия до
            наполнения.
          </Text>
          <Text>
            Быстро рассчитать распашной шкаф можно позвонив по телефону +7(911)997-82-57, а так же заполнив форму
