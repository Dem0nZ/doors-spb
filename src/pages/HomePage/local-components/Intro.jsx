...
const Intro = () => {
  ...
  return (
    <div className='relative'>
      <TextBlock className='absolute top-16 right-0 mx-12'>
      ...
      <TextBlock className='absolute bottom-16 left-0 mx-12'>
...
const TextBlock = tw.p`max-w-lg text-lg bg-gray-100 bg-opacity-50 p-2`;
